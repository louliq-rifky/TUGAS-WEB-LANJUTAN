...
<table>
        ...
        <tr>
            <td>Nomor KTP</td>
            <td><input type="text" name="pel_ktp" class="input-data" value="<?php echo $data['pel_ktp']?>"></td>
        </tr>
        <tr>
            <td>Nomor Seri</td>
            <td><input type="text" name="pel_seri" class="input-data" value="<?php echo $data['pel_seri']?>"></td>
        </tr>
        <tr>
            <td>Meteran</td>
            <td><input type="text" name="pel_meteran" class="input-data" value="<?php echo $data['pel_meteran']?>"></td>
        </tr>
        <tr>
            <td>Aktif</td>
            <td><input type="text" name="pel_aktif" class="input-data" value="<?php echo $data['pel_aktif']?>"></td>
        </tr>
        <tr>
            <td></td>
