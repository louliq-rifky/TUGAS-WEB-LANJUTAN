...
<form action="<?php echo URL; ?>/pelanggan/simpan" method="post">
    <table>
        ...
        <tr>
            <td>Nomor KTP</td>
            <td><input type="text" name="pel_ktp" class="input-data" ></td>
        </tr>
        <tr>
            <td>Nomor Seri</td>
            <td><input type="text" name="pel_seri" class="input-data" ></td>
        </tr>
        <tr>
            <td>Meteran</td>
            <td><input type="text" name="pel_meteran" class="input-data" ></td>
        </tr>
        <tr>
            <td>Aktif</td>
            <td><input type="text" name="pel_aktif" class="input-data" ></td>
        </tr>
        <tr>
            <td></td>
